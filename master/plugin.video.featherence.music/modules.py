...
def CATEGORIES10101(name, iconimage, desc, fanart):
	...
	addDir(localize(590),list,17,'featherenceserviceicons_path + music2.png',addonString(590).encode('utf-8'),'1',"http://reallifeglobal.com/wp-content/uploads/2012/06/music.jpg?467a33", getAddonFanart(background, custom=""))
...
def CATEGORIES10106(name, iconimage, desc, fanart):
	...
	addDir(localize(590),list,17,'featherenceserviceicons_path + musuc2.png',addonString(590).encode('utf-8'),'1',"http://reallifeglobal.com/wp-content/uploads/2012/06/music.jpg?467a33", getAddonFanart(background, custom=""))
...
def CATEGORIES11101(name, iconimage, desc, fanart):
	...
	'''Taylor Swift'''
	addDir(addonString(11104).encode('utf-8'),'TaylorSwiftVEVO',9,"http://upload.wikimedia.org/wikipedia/he/5/58/Taylor_Swift_-_Taylor_Swift_Album_Cover.png",addonString(111040).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	
	'''Usher'''
	addDir(addonString(11115).encode('utf-8'),'UsherVEVO',9,"http://www.usherdaily.com/wp-content/uploads/2015/02/usher-2014-cover-bb36-01-650.jpg",addonString(111150).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
...
def CATEGORIES11102(name, iconimage, desc, fanart):
	...
	'''אקראי'''
	#addDir(localize(590),'UC-9-kyTW8ZkZNDHQJ6FgpwQ',9,featherenceserviceicons_path + music2.png',"",'1',"", getAddonFanart(background, custom=""))
...
def CATEGORIES11104(name, iconimage, desc, fanart):
	...
	'''Aretha Franklin'''
	list = []
	list.append('&youtube_se=a3raW4rt2fE')
	list.append('&youtube_se=y0xZsepl4Is')
	list.append('&youtube_se=CbmB2nXJRDM')
	addDir(addonString(11126).encode('utf-8'),list,17,"http://sandiegofreepress.org/wp-content/uploads/2013/01/ARETHA-FRANKLIN-QUEEN-OF-SOUL.jpg",addonString(111260).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Coldplay'''
	list = []
	list.append('&youtube_se=vMAyzVr_fZI')
	addDir(addonString(11129).encode('utf-8'),list,17,"http://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2011/10/12/1318414177419/Coldplay-007.jpg",addonString(111290).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
	...
	'''Elton John'''
	list = []
	list.append('&youtube_se=9_5UFmJ7YhM')
	list.append('&youtube_se=9_3WKNlZg-qr8')
	addDir(addonString(11152).encode('utf-8'),list,17,"http://i.huffpost.com/gen/2722330/images/o-ELTON-JOHN-facebook.jpg",addonString(111520).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
...
def CATEGORIES11105(name, iconimage, desc, fanart):
	...
	'''אקראי Djs'''
	addDir(localize(590),list,17,'featherenceserviceicons_path + music2.png',addonString(590).encode('utf-8'),'1',"", getAddonFanart(background, custom=""))
